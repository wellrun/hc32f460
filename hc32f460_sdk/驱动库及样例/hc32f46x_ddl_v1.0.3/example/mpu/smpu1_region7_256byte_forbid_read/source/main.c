...
/** \file main.c
 **
 ** \brief This example demonstrates how to use read protection of SMPU1 region7
 **        256Byte range.
 **
...
#define MPU_RIGION_NUM                  MpuRegionNum7
#define MPU_RIGION_SIZE                 MpuRegionSize256Byte
...
int32_t main(void)
{
    ...
    stcProtRegionInit.stcSMPU1Permission.enWriteEnable = Enable;
    stcProtRegionInit.stcSMPU1Permission.enReadEnable = Disable;
