...
/** \file main.c
 **
 ** \brief This example demonstrates how to use write protection of SMPU2
 **        region6 8KByte range.
 **
...
#define MPU_RIGION_NUM                  MpuRegionNum6
#define MPU_RIGION_SIZE                 MpuRegionSize8KByte
...
int32_t main(void)
{
    ...
    stcProtRegionInit.u32RegionBaseAddress = (uint32_t)m_au8DstBuf;
    stcProtRegionInit.enRegionSize = MPU_RIGION_SIZE;
    stcProtRegionInit.stcSMPU2Permission.enRegionEnable = Enable;
    stcProtRegionInit.stcSMPU2Permission.enWriteEnable = Disable;
    stcProtRegionInit.stcSMPU2Permission.enReadEnable = Enable;
