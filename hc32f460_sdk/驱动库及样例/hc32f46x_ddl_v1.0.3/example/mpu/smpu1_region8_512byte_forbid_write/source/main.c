...
/** \file main.c
 **
 ** \brief This example demonstrates how to use write protection of SMPU1
 **        region8 512Byte range.
 **
...
#define MPU_RIGION_NUM                  MpuRegionNum8
#define MPU_RIGION_SIZE                 MpuRegionSize512Byte
