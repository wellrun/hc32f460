...
void Timer6_UnderFlow_CallBack(void)
{
    ...
    if( 0 == i)
    {
        Timer6_SetGeneralCmpValue(M4_TMR61, Timer6GenCompareE, 0x3000);
        Timer6_SetGeneralCmpValue(M4_TMR61, Timer6GenCompareF, 0x6000);
        i = 1;
    }
    else if(1 == i)
    {
        Timer6_SetGeneralCmpValue(M4_TMR61, Timer6GenCompareE, 0x4000);
        Timer6_SetGeneralCmpValue(M4_TMR61, Timer6GenCompareF, 0x4000);
        i = 2;
    }
    else
    {
        Timer6_SetGeneralCmpValue(M4_TMR61, Timer6GenCompareE, 0x6000);
        Timer6_SetGeneralCmpValue(M4_TMR61, Timer6GenCompareF, 0x3000);
        i = 0;
    }
}
...
int32_t main(void)
{
    ...
    stcTIM6PWMxCfg.enCmpc     = Timer6PWMxCompareInv;       //PWMA port output inverse level when CNTER value match with GCMxR
