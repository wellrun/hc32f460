...
void Timer6_Config(void)
{
    ...
    stcTIM6PWMxCfg.enStaOut   = Timer6PWMxPortOutHigh;      //PWMA port output set low level when CNTER start
    stcTIM6PWMxCfg.enStpOut   = Timer6PWMxPortOutHigh;      //PWMA port output set low level when CNTER stop
    stcTIM6PWMxCfg.enDisVal   = Timer6PWMxDisValHigh;       //PWMA port output high level when brake
    ...
    stcTIM6PWMxCfg.enStpOut   = Timer6PWMxPortOutHigh;      //PWMB port output set low level when CNTER stop
    stcTIM6PWMxCfg.enDisVal   = Timer6PWMxDisValHigh;       //PWMB port output high level when brake
...
int32_t main(void)
{
    ...
    stcEMBPWMlv.bEnTimer61HighLevelDect = false;       //Same Low level detection of Timer61 PWMA and PWMB port
