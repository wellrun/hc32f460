...
#define USBLIB_DEVICE_CORE                          DDL_OFF
#define USBLIB_HOST_CORE                            DDL_ON
#define USBLIB_DEVICE_CLASS                         DDL_OFF
#define USBLIB_HOST_CLASS                           DDL_ON

/*! ctl_drv file on-off define */
#define CTL_DRV_USB_CORE                             DDL_ON
#define CTL_DRV_USB_OTG                              DDL_ON
#define CTL_DRV_USB_DCD                              DDL_OFF
#define CTL_DRV_USB_DCD_INT                          DDL_OFF
#define CTL_DRV_USB_HCD                              DDL_ON
#define CTL_DRV_USB_HCD_INT                          DDL_ON
