...
/** \file main.c
 **
 ** \brief The example of QSPI two wire i/o fast read function
 **
...
void QspiFlash_Init(void)
{
    ...
    stcQspiInit.enVirtualPeriod = QspiVirtualPeriodQsck4;
    ...
    stcQspiInit.stcCommProtocol.enReadMode = QspiReadModeTwoWiresIO;
    ...
    stcQspiInit.u8RomAccessInstr = QSPI_3BINSTR_TWO_WIRES_IO_READ;
...
/**
 *******************************************************************************
 ** \brief  main function for QSPI two wire i/o fast read function
 **
 ** \param [in] None
 **
...
int32_t main(void)
{
    ...
    while (1)
    {
        if (1u == u8ExIntFlag)
        {
            ...
            /* Switch to two wire i/o fast read mode */
            stcQspiCommProtocol.enReadMode = QspiReadModeTwoWiresIO;
            QSPI_CommProtocolConfig(&stcQspiCommProtocol);
