...
/** \file main.c
 **
 ** \brief The example of QSPI fast read function
 **
 **   - 2018-11-02  1.0  Yangjp First version for Device Driver Library of QSPI.
 **
 ******************************************************************************/
...
void QspiFlash_Init(void)
{
    ...
    stcQspiInit.stcCommProtocol.enReadMode = QspiReadModeFast;
...
/**
 *******************************************************************************
 ** \brief  main function for QSPI fast read function
 **
 ** \param [in] None
 **
